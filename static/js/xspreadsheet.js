! function(t) {
			...
			value: function() {
				if (void 0 !== navigator.clipboard) {
					for (var t = "", e = this.rows.getData(), n = this.selector.range.sri; n <= this.selector.range.eri; n += 1) {
						if (ct(e, n)) {
							for (var r = this.selector.range.sci; r <= this.selector.range.eci; r += 1)
								if (r > this.selector.range.sci && (t += "\t"), ct(e[n].cells, r)) {
									var i = String(e[n].cells[r].text); - 1 === i.indexOf("\n") && -1 === i.indexOf("\t") && -1 === i.indexOf('"') ? t += i : t += '"'.concat(i, '"')
								}
						} else
							for (var o = this.selector.range.sci; o <= this.selector.range.eci; o += 1) t += "\t";
						t += "\n"
					}
						...
						if (p || "inside" !== n && "horizontal" !== n && "vertical" !== n)
							if ("outside" !== n || p) {
								if ("none" === n) a.range.each(function(t, n) {
									...
									for (var d = u; d <= h; d += 1) "top" === n && (ht.call(this, s, d, {
										top: [r, i]
									}), d += l.getCellMerge(s, d)[1]), "bottom" === n && (ht.call(this, f, d, {
										bottom: [r, i]
									}), d += l.getCellMerge(f, d)[1]);
								else if ("left" === n || "right" === n)
									for (var y = s; y <= f; y += 1) "left" === n && (ht.call(this, y, u, {
										left: [r, i]
									}), y += l.getCellMerge(y, u)[0]), "right" === n && (ht.call(this, y, h, {
										right: [r, i]
	...
	var qt = function() {
		...
		return Ct(t, [{
			...
			value: function() {
				var t = this,
					e = this.data.getClipboardRect();
				Vt.call(this, e), ["br", "l", "t", "tl"].forEach(function(e) {
					t[e].showClipboard()
				})
			}
		}, {
	...
	var oe = function() {
		function t() {
			! function(t, e) {
				if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
			}(this, t), this.calendar = new re(new Date), this.el = a("div", "".concat(kt, "-datepicker")).child(this.calendar.el).hide()
		}
		var e, n, r;
		return e = t, (n = [{
			key: "setValue",
				...
				if (" " !== s) {
					if (s >= "a" && s <= "z") r.push(s.toUpperCase());
						...
						if ("(" !== s && r.length > 0 && n.push(r.join("")), ")" === s) {
							var u = e.pop();
							if (2 === i) try {
									for (var p = Ae(f(n.pop()), 2), d = p[0], y = p[1], v = Ae(f(n.pop()), 2), b = v[0], g = v[1], m = 0, w = b; w <= d; w += 1)
	...
	function rn(t, e, n, r, i, o) {
		...
		l.attr({
			...
			var i = h + e,
				o = t;
			l.line([0, i], [n, i]), y <= o && o < b + 1 && nn.call(a, 0, i, n, r), l.fillText(o + 1, n / 2, i + r / 2), t > 0 && c.rows.isHide(t - 1) && (l.save(), l.attr({
				strokeStyle: "#c6c6c6"
			}), l.line([5, i + 5], [n - 5, i + 5]), l.restore())
		}), l.line([0, u + h], [n, u + h]), l.line([n, h], [n, u + h])), "all" !== t && "top" !== t || (c.colEach(e.sci, e.eci, function(t, e, n) {
			var i = p + e,
				o = t;
			l.line([i, 0], [i, r]), v <= o && o < g + 1 && nn.call(a, i, 0, n, r), l.fillText(s(o), i + n / 2, r / 2), t > 0 && c.cols.isHide(t - 1) && (l.save(), l.attr({
				strokeStyle: "#c6c6c6"
		...
		return e = t, (n = [{
			...
			value: function() {
				...
				var i = t.viewRange(),
					...
					c = l.x,
					s = l.y;
				on.call(this, i, n, r, o, a), en.call(this, i, n, r, -c, -s), rn.call(this, "all", i, n, r, o, a),
					function(t, e) {
						var n = this.draw;
						n.save(), n.attr({
							fillStyle: "#f4f5f8"
				...
				if (f > 0 || h > 0) {
					...
					on.call(this, y, n, r, 0, 0), rn.call(this, "all", y, n, r, 0, 0), en.call(this, y, n, r, 0, 0),
						function(t, e, n, r) {
							var i = this.draw,
								o = this.data,
								a = o.viewWidth() - t,
	...
	var Wn = function(t) {
		function e(t, n) {
			...
			return i = Mn(this, (r = Nn(e)).call.apply(r, [this, o, "auto", !0, "bottom-left"].concat(zn(l))))
		}
		var n, r, i;
		return function(t, e) {
			if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
	...
	var Ir = ["#ffffff", "#000100", "#e7e5e6", "#445569", "#5b9cd6", "#ed7d31", "#a5a5a5", "#ffc001", "#4371c6", "#71ae47"],
		Dr = [
		...
		zr = ["#c00000", "#fe0000", "#fdc101", "#ffff01", "#93d051", "#00b04e", "#01b0f1", "#0170c1", "#012060", "#7030a0"];
	...
	var Br = function(t) {
		function e(t, n) {
			...
			var i = new Gt(t).css("height", "16px").css("border-bottom", "3px solid ".concat(n)),
				o = new Mr;
	...
	var Zr = [
		...
		Kr = function(t) {
			function e(t) {
				...
				return r = Yr(this, (n = $r(e)).call.apply(n, [this, i, "auto", !1, "bottom-left"].concat(Ur(l))))
			}
			return function(t, e) {
				if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				t.prototype = Object.create(e && e.prototype, {
	...
	var ei = function t() {
		...
		var i = Qr(a("tr", "").children(a("td", "".concat(kt, "-border-palette-left")).child(Qr((e = a("tr", "")).children.apply(e, Jr(["all", "inside", "horizontal", "vertical", "outside"].map(function(t) {
			return ti.call(r, t)
		}))), (n = a("tr", "")).children.apply(n, Jr(["left", "top", "right", "bottom", "none"].map(function(t) {
			return ti.call(r, t)
	...
	var Xi = function(t) {
		function e() {
			...
			return n = Ui(this, (t = Yi(e)).call.apply(t, [this, "10", "60px", !0, "bottom-left"].concat(Li(r))))
		}
		return function(t, e) {
			if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
			t.prototype = Object.create(e && e.prototype, {
	...
	var ao = function(t) {
		function e() {
			...
			return n = ro(this, (t = io(e)).call.apply(t, [this, Te[0].title, "160px", !0, "bottom-left"].concat(no(r))))
		}
		return function(t, e) {
			if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
			t.prototype = Object.create(e && e.prototype, {
	...
	var wo = function(t) {
		function e() {
			...
			}), n = bo(this, (t = go(e)).call.apply(t, [this, "Normal", "220px", !0, "bottom-left"].concat(yo(r))))
		}
		var n, r, i;
		return function(t, e) {
			if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
	...
	var Ro = function(t) {
		function e() {
			...
			return n = To(this, (t = Po(e)).call.apply(t, [this, new Gt("formula"), "180px", !0, "bottom-left"].concat(Co(r))))
		}
		return function(t, e) {
			if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
			t.prototype = Object.create(e && e.prototype, {
		...
		Ya = function(t) {
			function e() {
				...
				var n = new Fa(new Ha("cell", ["cell"], "100%", function(t) {
						...
						required: !0
					}, "".concat(L("dataValidation.range"), ":"), Ua),
					r = new Fa(new Da("120px", "E3 or E3:F12"), {
						required: !0,
						pattern: /^([A-Z]{1,2}[1-9]\d*)(:[A-Z]{1,2}[1-9]\d*)?$/
					}),
					i = new Fa(new Ha("list", ["list", "number", "date", "phone", "email"], "100%", function(t) {
						return L("dataValidation.type.".concat(t))
					}, function(e) {
						return t.criteriaSelected(e)
					}), {
						required: !0
					}, "".concat(L("dataValidation.criteria"), ":"), Ua),
					o = new Fa(new Ha("be", ["be", "nbe", "eq", "neq", "lt", "lte", "gt", "gte"], "160px", function(t) {
				...
				return (t = qa(this, Ba(e).call(this, L("contextmenu.validation"), [a("div", "".concat(kt, "-form-fields")).children(n.el, r.el), a("div", "".concat(kt, "-form-fields")).children(i.el, o.el, l.el, c.el, u.el, s.el), a("div", "".concat(kt, "-buttons")).children(new ve("cancel").on("click", function() {
	...
	function rl(t, e) {
		...
		"left" === e ? c > 0 && (c -= 1) : "right" === e ? (f !== c && (c = f), c < o.len - 1 && (c += 1)) : "up" === e ? l > 0 && (l -= 1) : "down" === e ? (u !== l && (l = u), l < i.len - 1 && (l += 1)) : "row-first" === e ? c = 0 : "row-last" === e ? c = o.len - 1 : "col-first" === e ? l = 0 : "col-last" === e && (l = i.len - 1), t && (n.moveIndexes = [l, c]), nl.call(this, t, l, c),
			function() {
				var t = this.data,
	...
	function al() {
		var t = this.tableEl,
			...
			c = this.getRect();
		t.attr(c), e.offset(c), n.offset(l), a.css("width", "".concat(c.width, "px")), il.call(this), ol.call(this),
			function() {
				var t = this.selector,
					e = this.data,
					n = this.editor,
	...
	function hl(t) {
		...
		if (v.includes(d, y) && u + h - 20 < a && f + p - 20 < l) {
			...
			return o.hide(), o.set(y, b, v.getFilter(y), v.getSort(y)), void o.setOffset({
				left: u,
				top: f + p + 2
			})
		}
	...
	var Nl = function() {
			function t(e) {
				...
				this.options = function(t) {
					...
					showBottomBar: !0
				}, r), this.sheetIndex = 1, this.datas = [], "string" == typeof e && (i = document.querySelector(e)), this.bottombar = this.options.showBottomBar ? new Il(function() {
					var t = n.addSheet();
					n.sheet.resetData(t)
				}, function(t) {
					var e = n.datas[t];
			...
			return e = t, r = [{
				...
				value: function(t) {
					...
					if (null !== this.bottombar && this.bottombar.clear(), this.datas = [], e.length > 0)
